;(function($) {
    ...
    $(document).ready(function(){
        ...
        $("#featured_posts").find("div:eq(4)").css("display","none")/*fixed the error in the them*/
        /*----------------------------------------------------*/
        /*  Header Padditon Top
        /*----------------------------------------------------*/
        $('.header1.row').css( "padding-top", function(){
            return $('.header1 .navbar-fixed-top').height() + 40
        });
        ...
        /*  Go To
        /*----------------------------------------------------*/        
        $('.scrollspyMenu a[href^="#"], a[href="#all_posts"]').on('click', function(event) {
    ...
    $(window).load(function(){
        ...
        $("#featured_posts").find("div:eq(4)").css("display","none")/*to correct the theme*/
